...
def func_client(user):
    ...
    while True:
        ...
        #T0 D0: comando USER
            ...
            if channel == None:
                # validacao de nome
                if ' ' in desired_channel or len(desired_channel) > 9:
                    user.send("ERRO: O nome do servidor nao pode ter espaco e nem conter mais de 9 caracteres")
                else: 
